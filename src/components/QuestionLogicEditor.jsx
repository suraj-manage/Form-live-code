  ...
  return (
    <div style={{ marginTop: 10, padding: 10, borderRadius: 8, border: "1px solid #e6edf3", background: "#f9fafb" }}>
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
        ...
        <select value={selectedOption} onChange={(e) => setSelectedOption(e.target.value)} style={{ padding: "6px 8px", borderRadius: 6,color:"#14453f",border:"1px solid #10a594ff" }}>
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <input value={csv} onChange={(e) => setCsv(e.target.value)} placeholder="e.g. 2,4" style={{ width: "100%", padding: "6px 8px", borderRadius: 6, border: "1px solid #000000ff" ,color:"black"}} />
      </div>
